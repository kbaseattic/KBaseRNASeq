...
class KBaseGenomeUtil(object):
    ...
    def blast_against_genome(self, params, json_rpc_context = None):
        ...
        resp = self._call('KBaseGenomeUtil.blast_against_genome',
                          [params], json_rpc_context)
        return resp[0]
  
    def filter_BlastOutput(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method filter_BlastOutput: argument json_rpc_context is not type dict as required.')
        resp = self._call('KBaseGenomeUtil.filter_BlastOutput',
                          [params], json_rpc_context)
        return resp[0]
