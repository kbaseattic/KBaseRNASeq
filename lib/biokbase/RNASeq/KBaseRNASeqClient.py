...
class KBaseRNASeq(object):
    ...
    def _Hisat2StringTieCall_submit(self, params, context=None):
        return self._client._submit_job(
             'KBaseRNASeq.Hisat2StringTieCall', [params],
             self._service_ver, context)

    def Hisat2StringTieCall(self, params, context=None):
        """
        ...
        :returns: instance of type "ResultsToReport" (Object for Report type)
           ...
           "report_ref" of String
        """
        job_id = self._Hisat2StringTieCall_submit(params, context)
        async_job_check_time = self._client.async_job_check_time
        while True:
            time.sleep(async_job_check_time)
            async_job_check_time = (async_job_check_time *
