...
sync_methods['KBaseRNASeq.fastqcCall'] = True
...
sync_methods['KBaseRNASeq.associateReads'] = True
...
sync_methods['KBaseRNASeq.SetupRNASeqAnalysis'] = True
...
sync_methods['KBaseRNASeq.createExpressionHistogram'] = True
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "KBaseRNASeq but no authentication header was passed"
                            raise err
