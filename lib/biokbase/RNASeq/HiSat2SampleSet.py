...
class HiSat2SampleSet(HiSat2): 
    ...
    def collect(self, common_params, method_params) :
        ...
        alignmentSet_name = global_params['sampleset_id']+"_hisat2_AlignmentSet"
        ...
        #reportObj=rnaseq_util.create_RNASeq_AlignmentSet_and_build_report(self.logger,common_params['ws_client'],self.method_params['ws_id'],self.sample['data']['sample_ids'],self.task_list[0]['sampleset_id'],self.task_list[0]['annotation_id'],None,self.results,alignmentSet_name)
