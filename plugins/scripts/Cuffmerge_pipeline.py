...
def main():
    ...
    yargs['cuffmerge_options'] = args.opts_dict
    yargs['cuffmerge_options']['o'] = args.output
    yargs['cuffmerge_options']['positional_args']= dict()
    yargs['cuffmerge_options']['positional_args']['assembly_list'] = args.input
    ...
    if hasattr(args , 'gtf'):
        yargs['cuffmerge_options']['G'] = "from_conditions"
    ...
    if start_prog(args.prog, ['cuffmerge', 'all']):
    	...
    	print yargs.cuffmerge_options
	cuffmerge_call = CuffmergeCall(yargs, run_id, run_logs, conditions=yargs.condition, mode=args.mode)
